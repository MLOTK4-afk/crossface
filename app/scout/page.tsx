  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <input
        ...
        className="mt-6 w-full rounded-lg border border-white/15 bg-white/5 px-4 py-3 text-white placeholder:text-slate-500 focus:border-electric-500 focus:outline-none focus:ring-1 focus:ring-electric-500"
        autoFocus
      />
      ...
      {!selected && !needle && (
        <div className="mt-10">
          <EmptyState
            title="Search a wrestler to get started"
            description="Pull up anyone's record and weight class before you step on the mat — and see if a teammate has already logged a match against them."
          />
        </div>
      )}
